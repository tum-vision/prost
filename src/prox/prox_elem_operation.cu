...
// ElemOperationSingular3x2<Function2DSum1D>
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DSum1D<float, Function1DZero<float>>>>;
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DSum1D<float, Function1DAbs<float>>>>;
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DSum1D<float, Function1DSquare<float>>>>;
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DSum1D<float, Function1DIndLeq0<float>>>>;
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DSum1D<float, Function1DIndGeq0<float>>>>;
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DSum1D<float, Function1DIndEq0<float>>>>;
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DSum1D<float, Function1DIndBox01<float>>>>;
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DSum1D<float, Function1DMaxPos0<float>>>>;
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DSum1D<float, Function1DL0<float>>>>;
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DSum1D<float, Function1DHuber<float>>>>;

// ElemOperationSingular3x2<other>
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DIndL1Ball<float>>>;
template class ProxElemOperation<float, ElemOperationSingular3x2<float, Function2DMoreau<float, Function2DIndL1Ball<float>>>>;
...
// ElemOperationSingular3x2<Function2DSum1D>
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DSum1D<double, Function1DZero<double>>>>;
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DSum1D<double, Function1DAbs<double>>>>;
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DSum1D<double, Function1DSquare<double>>>>;
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DSum1D<double, Function1DIndLeq0<double>>>>;
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DSum1D<double, Function1DIndGeq0<double>>>>;
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DSum1D<double, Function1DIndEq0<double>>>>;
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DSum1D<double, Function1DIndBox01<double>>>>;
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DSum1D<double, Function1DMaxPos0<double>>>>;
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DSum1D<double, Function1DL0<double>>>>;
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DSum1D<double, Function1DHuber<double>>>>;

// ElemOperationSingular3x2<other>
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DIndL1Ball<double>>>;
template class ProxElemOperation<double, ElemOperationSingular3x2<double, Function2DMoreau<double, Function2DIndL1Ball<double>>>>;
