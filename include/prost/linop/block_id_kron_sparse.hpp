...
#ifndef PROST_BLOCK_ID_KRON_SPARSE_HPP_
#define PROST_BLOCK_ID_KRON_SPARSE_HPP_
...
///
template<typename T>
class BlockIdKronSparse : public Block<T>
{
  BlockIdKronSparse(size_t row, size_t col, size_t nrows, size_t ncols);
  
 public:
  static BlockIdKronSparse<T> *CreateFromCSC(
      size_t row,
      size_t col,
      size_t diaglength,
      int m,
 ...
 private:
  ...
  /// \brief GPU data for small sparse matrix M
