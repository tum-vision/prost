function [passed] = test_linop_id_kron_sparse()
    ...
    block_fun = prost.block.id_kron_sparse(K_mat, diaglength);
    make_block_id_kron_sparse_1 = ...
        block_fun(0, ...
                  0, ...
                  size(K_mat, 1) * diaglength, ...
                  size(K_mat, 2) * diaglength);

    make_block_id_kron_sparse_2 = ...
        block_fun(size(K_mat, 1) * diaglength, ...
                  0, ...
                  size(K_mat, 1) * diaglength, ...
                  size(K_mat, 2) * diaglength);

    make_block_id_kron_sparse_3 = ...
        block_fun(size(K_mat, 1) * diaglength, ...
                  size(K_mat, 2) * diaglength, ...
                  size(K_mat, 1) * diaglength, ...
                  size(K_mat, 2) * diaglength);

    make_block_id_kron_sparse_4 = ...
        block_fun(0, ...
                  size(K_mat, 2) * diaglength, ...
                  size(K_mat, 1) * diaglength, ...
                  size(K_mat, 2) * diaglength);
    ...
    linop = { ...
        make_block_id_kron_sparse_1{1}; ...
        make_block_id_kron_sparse_2{1}; ...
        make_block_id_kron_sparse_3{1}; ...
        make_block_id_kron_sparse_4{1}; ...
            };
